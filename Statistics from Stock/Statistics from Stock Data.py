...
apple_stock = apple_stock = apple_stock.rename(columns={'Adj Close': 'Apple'})


# Change the Adj Close column label to Amazon
amazon_stock = amazon_stock = amazon_stock.rename(columns={'Adj Close': 'Amazon'})
...
avg_price = all_stocks.mean()

# Print the median stock price for each stock
median_price = all_stocks.median()

# Print the standard deviation of the stock price for each stock  
std_dev = all_stocks.std()
